...
const CargoTruck6WheelerVersion2 = () => {
  ...
  const Sinotruck = [{ image: images.CargoTruck6WheelerVersion2, name: 'CargoTruck6WheelerVersion2', link: 'CargoTruck6WheelerVersion2' }];
  ...
  return (
    <div id="CargoTruck6WheelerVersion2" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[270px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
    ...
    >
      <h1 className="text-4xl text-indigo-500">Cargo 6 Wheeler Version 2</h1>
      <br />
...
export default CargoTruck6WheelerVersion2;
