...
const Giga4x2TractorHead = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga4x2TractorHead, name: 'Giga4x2TractorHead', link: 'Giga4x2TractorHead' }];
  ...
  return (
    <div id="Giga4x2TractorHead" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        className="object-contain w-auto text-transparent relative lg:-bottom-4 -bottom-12"
      />
      {loading && (
...
export default Giga4x2TractorHead;
