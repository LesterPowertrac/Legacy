...
const FTR = () => {
  ...
  const KinglingIsuzu = [{ image: images.FTR, name: 'FTR', link: 'FTR' }];
  ...
  return (
    <div id="FTR" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">FTR 6x4 Tractor Head</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu FTR 6x4 Tractor Head is a heavy-duty tractor unit designed for long-haul transportation of heavy loads, offering robust performance and superior load-carrying capacity. Maximize your heavy-haul logistics operations with the Kingling Isuzu FTR 6x4 Tractor Head, the ideal solution for reliable and efficient transport of heavy loads.</p>
      <br />
