...
const Giga6x4TractorHead = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga6x4TractorHead, name: 'Giga6x4TractorHead', link: 'Giga6x4TractorHead' }];
  ...
  return (
    <div id="Giga6x4TractorHead" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Giga 6x4 Tractor Head</h1>
      <br />
...
export default Giga6x4TractorHead;
