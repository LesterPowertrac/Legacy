...
const H7 = () => {
  ...
  const Forland = [{ image: images.H7, name: 'H7', link: 'H7' }];
  ...
  return (
    <div id="H7" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland L7 Cargo Truck</h1>
              <br />
              <p className='text-white'>The Forland L7 Cargo Truck is a robust vehicle designed to handle various cargo transportation needs, offering ample storage space and efficient performance. Elevate your logistics operations with the Forland L7 Cargo Truck, the perfect solution for businesses seeking a reliable and powerful transportation partner.</p>
              <br />
