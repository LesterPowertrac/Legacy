...
const IsuzuBus = () => {
  ...
  const KinglingIsuzu = [{ image: images.IsuzuBus, name: 'IsuzuBus', link: 'IsuzuBus' }];
  ...
  return (
    <div id="IsuzuBus" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[360px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
    ...
    >
      <h1 className="text-4xl text-indigo-500">Kingling Isuzu Bus</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu Bus is a versatile bus designed for efficient passenger transportation, offering a comfortable ride and durable performance. Elevate your passenger transportation experience with the Kingling Isuzu Bus, the ideal solution for reliable and comfortable journeys.</p>
      <br />
