...
const NKR600p = () => {
  ...
  const KinglingIsuzu = [{ image: images.NKR600p, name: 'NKR600p', link: 'NKR600p' }];
  ...
  return (
    <div id="NKR600p" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">NKR 600p</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu NKR 600P is a versatile light-duty truck designed for various transportation needs, offering a balance of power, fuel efficiency, and maneuverability. Optimize your light-duty operations with the Kingling Isuzu NKR 600P, the ideal solution for reliable and efficient urban deliveries.</p>
      <br />
