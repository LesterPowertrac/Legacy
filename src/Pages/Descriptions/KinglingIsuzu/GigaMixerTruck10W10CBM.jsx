...
const GigaMixerTruck10W10CBM = () => {
  ...
  const KinglingIsuzu = [{ image: images.GigaMixerTruck10W10CBM, name: 'GigaMixerTruck10W10CBM', link: 'GigaMixerTruck10W10CBM' }];
  ...
  return (
    <div id="GigaMixerTruck10W10CBM" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[390px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
    ...
    >
      <h1 className="text-4xl text-indigo-500">Giga Mixer Truck 10W 10CBM</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu Giga 10W 10CBM Mixer Truck is a heavy-duty vehicle designed for efficient concrete mixing and transportation, offering a robust build and advanced mixing technology. Optimize your large-scale construction projects with the Kingling Isuzu Giga 10W 10CBM Mixer Truck, the ideal solution for reliable and efficient concrete delivery.</p>
      <br />
...
export default GigaMixerTruck10W10CBM;
