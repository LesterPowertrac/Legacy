...
const Excavator = () => {
  ...
  const productImages = {
    Excavator: `${apiUrl}/products/Excavator`,
  };
  ...
  const Weichai = [{ image: images.Excavator, name: 'Excavator', link: 'Excavator' }];
  ...
  return (
    <div id="Excavator" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Weichai.map((weichai) => (
  <div 
    className="flex flex-col items-center mb-8 lg:flex-row lg:items-start lg:justify-between w-9/12 lg:w-[1150px] md:w-auto  mt-20 " 
    key={weichai.name}
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[380px] h-[450px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={weichai.image}
        alt={weichai.name}
        className=" object-contain w-auto text-transparent relative lg:bottom-12 bottom-2  lg:h-[29rem]"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Excavator WE210E2</h1>
      <br />
      <p className='text-white'>The Weichai Excavator WE210E2 is a powerful and versatile machine, equipped with a fuel-efficient engine, advanced hydraulic system, and durable components, making it ideal for heavy-duty excavation and construction tasks</p>
      <br />
    ...
    <div id='Specs' className='mt-12 relative bottom-32'></div>
      <div className=" bg-zinc-800  lg:max-w-6xl max-w-md max-h-lvh overflow-x-auto  mb-10 rounded-lg">
        ...
        <table className="border-colapse  w-full text-white border border-zinc-700  mb-10 rounded-md ">
          <tbody className="text-center">
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              ...
              <th className="px-4 py-2 border-r" colSpan={2}>Main Performance</th>       
              <th className="px-4 py-2 border-r" colSpan={2}>Oil Capacity</th>        
            </tr>
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              <td className="px-4 py-2 border-r">Engine Model</td>
              <td className="px-4 py-2 border-r">ISUZU 4HK1</td>

              <td className="px-4 py-2 border-r">Max. Main Pump Flow</td>
              <td className="px-4 py-2 border-r">2x234L</td>

              <td className="px-4 py-2 border-r">Bucket Digging Force</td>
              <td className="px-4 py-2 border-r">156kN</td>

              <td className="px-4 py-2 border-r">Fuel Tank</td>
              <td className="px-4 py-2 border-r">385L</td>
            </tr>
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              <td className="px-4 py-2 border-r">Number of Cylinders</td>
              <td className="px-4 py-2 border-r">4</td>
              
              <td className="px-4 py-2 border-r">Main Safety Valve Pressure</td>
              <td className="px-4 py-2 border-r">34.3MPa</td>

              <td className="px-4 py-2 border-r">Arm Digging Force</td>
              <td className="px-4 py-2 border-r">109kN</td>

              <td className="px-4 py-2 border-r">Hydraulic Tank </td>
              <td className="px-4 py-2 border-r">220L</td>
            </tr>
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              <td className="px-4 py-2 border-r">Max. Torque/Speed</td>
              <td className="px-4 py-2 border-r">657N·m/1500rpm</td>

              <td className="px-4 py-2 border-r" colSpan={2}></td>
             

              <td className="px-4 py-2 border-r">Max. Traction Force</td>
              <td className="px-4 py-2 border-r">217kN</td>

              <td className="px-4 py-2 border-r">Engine Oil</td>
              <td className="px-4 py-2 border-r">20.5L</td>
            </tr>
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              <td className="px-4 py-2 border-r">Displacement</td>
              <td className="px-4 py-2 border-r">5.193L</td>

              <td className="px-4 py-2 border-r" colSpan={2}></td>
            

              <td className="px-4 py-2 border-r">Max. Walking Speed</td>
              <td className="px-4 py-2 border-r">5.1km/h</td>
            ...
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              ...
              <td className="px-4 py-2 border-r">Min. Walking Speed</td>
              <td className="px-4 py-2 border-r">3.1km/h</td>
            ...
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              ...
              <td className="px-4 py-2 border-r">Rotary Speed</td>
              <td className="px-4 py-2 border-r">12r/min</td>
            ...
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              ...
              <td className="px-4 py-2 border-r">Gradeability</td>
              <td className="px-4 py-2 border-r">35°</td>
            ...
            <tr className='odd:bg-zinc-700 even:bg-zinc-800'>
              ...
              <td className="px-4 py-2 border-r">Ground Pressure</td>
              <td className="px-4 py-2 border-r">47.5kPa</td>
