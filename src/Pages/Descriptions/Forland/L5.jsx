...
;
  ...
  const Forland = [{ image: images.L5, name: 'L5', link: 'L5' }];
  ...
  return (
    <div id="L5" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[300px] h-[240px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
            ...
            >
              <h1 className="text-4xl text-indigo-500">L5</h1>
              <br />
              <p className='text-white'>The Forland L5 Cargo Truck is a medium-duty vehicle designed for efficient transportation of various loads, offering a balance of power and maneuverability. Optimize your medium-duty hauling operations with the Forland L5 Cargo Truck, the perfect choice for businesses seeking a reliable and efficient transport solution.</p>
              <br />
