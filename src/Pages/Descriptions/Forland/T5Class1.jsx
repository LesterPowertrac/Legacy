...
const T5Class1 = () => {
  ...
  const Forland = [{ image: images.T5Class1, name: 'T5Class1', link: 'T5Class1' }];
  ...
  return (
    <div id="T5Class1" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[420px] h-[290px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
                alt={Forland.name}
                className="object-contain w-auto text-transparent relative lg:-bottom-4 -bottom-3"
              />
              {loading && (
            ...
            >
              <h1 className="text-4xl text-indigo-500">T5 Mordern Jeepney Class 1</h1>
              <br />
              <p className='text-white'>The Forland T5 Modern Jeepney Class 1 is a state-of-the-art public utility vehicle designed to provide safe, efficient, and comfortable transportation for passengers. Experience the future of public transportation with the Forland T5 Modern Jeepney Class 1, offering a superior ride and enhanced passenger experience.</p>
              <br />
