...
const ShacmanDumpTruckH3000 = () => {
  ...
  const Shacman = [{ image: images.ShacmanDumpTruckH3000, name: 'ShacmanDumpTruckH3000', link: 'ShacmanDumpTruckH3000' }];
  ...
  return (
    <div id="ShacmanDumpTruckH3000" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        src={Shacman.image}
        alt={Shacman.name}
        className="object-contain w-auto text-transparent relative lg:bottom-20  "
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Dump Truck H3000</h1>
      <br />
      <p className='text-white'>The Shacman H3000 Dump Truck is a heavy-duty vehicle designed for efficient material transportation, offering a robust build and reliable performance. Maximize your construction site efficiency with the Shacman H3000 Dump Truck, the ideal solution for heavy-duty hauling and material transport.</p>
      <br />
...
export default ShacmanDumpTruckH3000;
