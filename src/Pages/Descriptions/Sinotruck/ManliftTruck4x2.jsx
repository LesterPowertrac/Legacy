...
const ManliftTruck4x2 = () => {
  ...
  const productImages = {
    ManliftTruck4x2: `${apiUrl}/products/ManliftTruck4x2`,
  };
  ...
  const Sinotruck = [{ image: images.ManliftTruck4x2, name: 'ManliftTruck4x2', link: 'ManliftTruck4x2' }];
  ...
  return (
    <div id="ManliftTruck4x2" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Sinotruk 4x2 Manlift Truck</h1>
      <br />
      <p className='text-white'>The 4x2 Manlift Truck is a heavy-duty vehicle equipped with a hydraulic platform, designed to elevate workers and equipment to significant heights for maintenance, construction, and other aerial work. Maximize your productivity and safety with the 4x2 Manlift Truck, the ideal solution for efficient and reliable aerial work.</p>
      <br />
...
export default ManliftTruck4x2;
