...
const CargoTruck6Wheeler = () => {
  ...
  const productImages = {
    CargoTruck6Wheeler: `${apiUrl}/products/CargoTruck6Wheeler`,
  };
  ...
  const Sinotruck = [{ image: images.CargoTruck6Wheeler, name: 'CargoTruck6Wheeler', link: 'CargoTruck6Wheeler' }];
  ...
  return (
    <div id="CargoTruck6Wheeler" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Cargo Truck 6 Wheeler</h1>
      <br />
      <p className='text-white'>The Sinotruk 6 Wheeler Cargo Truck is a heavy-duty vehicle designed for efficient transportation of large loads, offering a balance of power, durability, and payload capacity. Maximize your heavy-duty hauling capabilities with the Sinotruk 6 Wheeler Cargo Truck, the ideal solution for demanding transportation needs.</p>
      <br />
...
export default CargoTruck6Wheeler;
