...
const GTH6x4300HP = () => {
  ...
  const KinglingIsuzu = [{ image: images.GTH6x4300HP, name: 'GTH6x4300HP', link: 'GTH6x4300HP' }];
  ...
  return (
    <div id="GTH6x4300HP" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  <div 
    className="flex flex-col items-center mb-8 lg:flex-row lg:items-start lg:justify-between w-9/12 lg:w-[1150px] md:w-auto" 
    key={KinglingIsuzu.name}
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[320px] h-[250px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:bottom-0 -bottom-5"
      />
      {loading && (
    ...
    {/* Text Content */}
    <div 
      className="lg:w-11/12  w-full flex flex-col items-center lg:items-start justify-center lg:justify-start lg:p-8 p-4  mt-24"
    >
      <h1 className="text-4xl text-indigo-500">GTH 6x4 300HP</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu GTH 6x4 300HP is a heavy-duty tractor unit designed for long-haul transportation of heavy loads, offering robust performance and superior load-carrying capacity. Maximize your heavy-haul logistics operations with the Kingling Isuzu GTH 6x4 300HP, the ideal solution for reliable and efficient transport of the heaviest loads.</p>
      <br />
