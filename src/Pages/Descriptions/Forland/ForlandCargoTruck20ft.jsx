...
const ForlandCargoTruck20ft = () => {
  ...
  const Forland = [{ image: images.ForlandCargoTruck20ft, name: 'ForlandCargoTruck20ft', link: 'ForlandCargoTruck20ft' }];
  ...
  return (
    <div id="ForlandCargoTruck20ft" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[300px] h-[205px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
                alt={Forland.name}
                className="object-contain w-auto text-transparent relative lg:-bottom-0 -bottom-0"
              />
              {loading && (
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland Cargo Truck 20ft</h1>
              <br />
              <p className='text-white'>The Forland Cargo Truck 20ft is a robust 20-foot cargo truck, designed to handle heavy-duty loads with ease. Elevate your hauling capabilities with the Forland Cargo Truck 20ft, the ultimate choice for demanding transportation needs.</p>
              <br />
...
export default ForlandCargoTruck20ft;
