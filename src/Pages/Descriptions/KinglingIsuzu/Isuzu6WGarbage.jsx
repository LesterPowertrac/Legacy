...
const Isuzu6WGarbage = () => {
  ...
  const KinglingIsuzu = [{ image: images.Isuzu6WGarbage, name: 'Isuzu6WGarbage', link: 'Isuzu6WGarbage' }];
  ...
  return (
    <div id="Isuzu6WGarbage" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Kingling Isuzu 6W Garbage</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu 6W Garbage Truck is a heavy-duty vehicle designed for efficient waste collection and transportation, featuring a robust build and advanced compaction technology. Optimize your waste management operations with the Kingling Isuzu 6W Garbage Truck, the ideal solution for efficient and hygienic waste disposal.</p>
      <br />
