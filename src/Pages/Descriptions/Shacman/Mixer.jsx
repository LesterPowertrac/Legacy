...
const Mixer = () => {
  ...
  const Shacman = [{ image: images.Mixer, name: 'Mixer', link: 'Mixer' }];
  ...
  return (
    <div id="Mixer" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Mixer</h1>
      <br />
      <p className='text-white'>The Shacman Mixer Truck is a heavy-duty vehicle designed for efficient concrete mixing and transportation, featuring a robust build and advanced mixing technology. Optimize your construction projects with the Shacman Mixer Truck, the ideal solution for reliable and efficient concrete delivery.</p>
      <br />
