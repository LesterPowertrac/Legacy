...
const L3 = () => {
  ...
  const Forland = [{ image: images.L3, name: 'L3', link: 'L3' }];
  ...
  return (
    <div id="L3" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland L3 Cargo truck</h1>
              <br />
              <p className='text-white'>The Forland L3 Cargo Truck is a versatile light-duty vehicle designed for various transportation needs, offering a balance of maneuverability and cargo capacity. Maximize your urban deliveries with the Forland L3 Cargo Truck, the ideal solution for efficient and reliable transportation in tight city spaces.</p>
              <br />
