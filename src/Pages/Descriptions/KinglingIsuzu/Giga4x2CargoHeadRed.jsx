...
const Giga4x2CargoHeadRed = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga4x2CargoHeadRed, name: 'Giga4x2CargoHeadRed', link: 'Giga4x2CargoHeadRed' }];
  ...
  return (
    <div id="Giga4x2CargoHeadRed" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[380px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-14 -bottom-16"
      />
      {loading && (
...
export default Giga4x2CargoHeadRed;
