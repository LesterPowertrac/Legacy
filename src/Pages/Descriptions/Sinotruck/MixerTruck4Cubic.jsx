...
const MixerTruck4Cubic = () => {
  ...
  const Sinotruck = [{ image: images.MixerTruck4Cubic, name: 'MixerTruck4Cubic', link: 'MixerTruck4Cubic' }];
  ...
  return (
    <div id="MixerTruck4Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[290px] h-[240px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
    ...
    >
      <h1 className="text-4xl text-indigo-500">Mixer Truck 4 Cubic</h1>
      <br />
      <p className='text-white'>The Sinotruk 4 Cubic Meter Mixer Truck is a heavy-duty vehicle designed for efficient concrete mixing and transportation, featuring a robust build and advanced mixing technology. Optimize your construction projects with the Sinotruk 4 Cubic Meter Mixer Truck, the ideal solution for reliable and efficient concrete delivery.</p>
      <br />
...
export default MixerTruck4Cubic;
