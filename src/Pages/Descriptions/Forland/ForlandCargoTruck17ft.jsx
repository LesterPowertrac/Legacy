...
const ForlandCargoTruck17ft = () => {
  ...
  const Forland = [{ image: images.ForlandCargoTruck17ft, name: 'ForlandCargoTruck17ft', link: 'ForlandCargoTruck17ft' }];
  ...
  return (
    <div id="ForlandCargoTruck17ft" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland Cargo Truck 17ft</h1>
              <br />
              <p className='text-white'>The Forland Cargo Truck 17ft is a spacious 17-foot cargo truck, ideal for transporting larger loads with ease. Maximize your hauling capacity with the Forland Cargo Truck 17ft, the perfect choice for your growing business.</p>
              <br />
...
export default ForlandCargoTruck17ft;
