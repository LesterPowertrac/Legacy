...
const ShacmanSelfLoader = () => {
  ...
  const Shacman = [{ image: images.ShacmanSelfLoader, name: 'ShacmanSelfLoader', link: 'ShacmanSelfLoader' }];
  ...
  return (
    <div id="ShacmanSelfLoader" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        src={Shacman.image}
        alt={Shacman.name}
        className="object-contain w-auto text-transparent relative lg:bottom-0 -bottom-14"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Self Loader</h1>
      <br />
      <p className='text-white'>Optimize your liquid transportation needs with the Shacman Fuel Tanker, a reliable and durable solution for efficient delivery.   
...
export default ShacmanSelfLoader;
