...
const IsuzuFVR6Wheeler6000LitersPTOFireTruck = () => {
  ...
  const KinglingIsuzu = [{ image: images.IsuzuFVR6Wheeler6000LitersPTOFireTruck, name: 'IsuzuFVR6Wheeler6000LitersPTOFireTruck', link: 'IsuzuFVR6Wheeler6000LitersPTOFireTruck' }];
  ...
  return (
    <div id="IsuzuFVR6Wheeler6000LitersPTOFireTruck" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[330px] h-[260px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:bottom-5 -bottom-3"
      />
      {loading && (
...
export default IsuzuFVR6Wheeler6000LitersPTOFireTruck;
