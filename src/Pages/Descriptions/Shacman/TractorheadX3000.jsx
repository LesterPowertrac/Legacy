...
const TractorheadX3000 = () => {
  ...
  const Shacman = [{ image: images.TractorheadX3000, name: 'TractorheadX3000', link: 'TractorheadX3000' }];
  ...
  return (
    <div id="TractorheadX3000" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        src={Shacman.image}
        alt={Shacman.name}
        className="object-contain w-auto text-transparent relative lg:bottom-20  bottom-3"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Tractor Head X3000</h1>
      <br />
      <p className='text-white'>The Shacman X3000 Tractor Head is a heavy-duty tractor unit designed for long-haul transportation, offering robust performance, advanced technology, and superior fuel efficiency. Maximize your long-haul logistics operations with the Shacman X3000 Tractor Head, the ideal solution for reliable and efficient freight transport. Sources and related content</p>
      <br />
...
export default TractorheadX3000;
