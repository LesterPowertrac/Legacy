...
const KVAPowergen = () => {
  ...
  return (
    <div id="KVAPowergen" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
          <title>Product Descriptions | The Legacy</title>
          <meta name="description" content="Explore our extensive range of construction equipment, trucks, and machinery from top brands like powergen, powergen, Shacman, Kingling Isuzu, Sinotruck, and Forland." />
        </Helmet>
    ...
    `}
            ...
            {powergen.map((powergen) => (
              ...
              <img
                ...
                src={powergen.image}
                alt={powergen.name}
                className="object-contain w-auto text-transparent  relative lg:bottom-20  p-20 bottom-20 "
              />
              </SwiperSlide>
            ))}
              </Swiper>
            ...
            >
              <h1 className="text-4xl text-indigo-500">Weichai Powergen <br/>15-5850 KVA</h1>
              <br />
              <p className='text-white'>Weichai Powergen provides a comprehensive range of diesel generator sets with power outputs from 15 to 5850 kVA, designed for diverse power needs and delivering reliable performance. Power your projects with Weichai Powergen, offering a wide range of diesel generators from 15 to 5850 kVA for reliable and efficient power solutions.</p>
              <br />
