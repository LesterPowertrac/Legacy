...
const T5 = () => {
  ...
  const Forland = [{ image: images.T5, name: 'T5', link: 'T5' }];
  ...
  return (
    <div id="T5" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[455px] h-[320px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland T5 Cargo Truck</h1>
              <br />
              <p className='text-white'>The Forland T5 Cargo Truck is a light-duty vehicle designed for efficient transportation of various loads, offering a balance of maneuverability and cargo capacity. Optimize your urban deliveries with the Forland T5 Cargo Truck, the ideal solution for efficient and reliable transportation in tight city spaces.</p>
              <br />
