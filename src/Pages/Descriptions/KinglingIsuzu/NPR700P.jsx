...
;
  ...
  const KinglingIsuzu = [{ image: images.NPR700P, name: 'NPR700P', link: 'NPR700P' }];
  ...
  return (
    <div id="NPR700P" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">NPR 700P</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu NPR 700P is a versatile medium-duty truck designed for various transportation needs, offering a balance of power, fuel efficiency, and durability. Optimize your medium-duty operations with the Kingling Isuzu NPR 700P, the ideal solution for reliable and efficient transportation.</p>
      <br />
