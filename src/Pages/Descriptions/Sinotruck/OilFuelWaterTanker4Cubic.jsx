...
const OilFuelWaterTanker4Cubic = () => {
  ...
  const Sinotruck = [{ image: images.OilFuelWaterTanker4Cubic, name: 'OilFuelWaterTanker4Cubic', link: 'OilFuelWaterTanker4Cubic' }];
  ...
  return (
    <div id="OilFuelWaterTanker4Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[250px] h-[220px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
    ...
    >
      <h1 className="text-4xl text-indigo-500">Oil Fuel Water Tanker 4 Cubic</h1>
      <br />
      <p className='text-white'>The Sinotruk 4 Cubic Meter Oil Fuel Water Tanker is a heavy-duty vehicle designed for safe and efficient transportation of various liquids, including oil, fuel, and water. Optimize your liquid transportation needs with the Sinotruk 4 Cubic Meter Oil Fuel Water Tanker, a reliable and durable solution for efficient delivery.</p>
      <br />
...
export default OilFuelWaterTanker4Cubic;
