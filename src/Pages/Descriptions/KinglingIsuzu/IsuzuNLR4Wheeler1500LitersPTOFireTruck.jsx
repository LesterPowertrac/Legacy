...
const IsuzuNLR4Wheeler1500LitersPTOFireTruck = () => {
  ...
  const KinglingIsuzu = [{ image: images.IsuzuNLR4Wheeler1500LitersPTOFireTruck, name: 'IsuzuNLR4Wheeler1500LitersPTOFireTruck', link: 'IsuzuNLR4Wheeler1500LitersPTOFireTruck' }];
  ...
  return (
    <div id="IsuzuNLR4Wheeler1500LitersPTOFireTruck" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[340px] h-[280px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:bottom-0 -bottom-8"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Isuzu NLR 4 Wheeler 1500Liters PTO Firetruck</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu NLR 4 Wheeler Firetruck is a light-duty vehicle equipped with a water tank and firefighting equipment, designed for quick response to small-scale fires. Protect your community with the Kingling Isuzu NLR 4 Wheeler Firetruck, a reliable and efficient firefighting solution for urban areas.</p>
      <br />
...
export default IsuzuNLR4Wheeler1500LitersPTOFireTruck;
