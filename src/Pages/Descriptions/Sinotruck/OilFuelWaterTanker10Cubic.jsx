...
const OilFuelWaterTanker10Cubic = () => {
  ...
  const Sinotruck = [{ image: images.OilFuelWaterTanker10Cubic, name: 'OilFuelWaterTanker10Cubic', link: 'OilFuelWaterTanker10Cubic' }];
  ...
  return (
    <div id="OilFuelWaterTanker10Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        src={Sinotruck.image}
        alt={Sinotruck.name}
        className="object-contain w-auto text-transparent relative lg:bottom-16 bottom-5"
      />
      {loading && (
    ...
    >
      ...
      <br />
      <p className='text-white'>The Sinotruk 4 Cubic Meter Tanker is a heavy-duty vehicle designed for safe and efficient transportation of various liquids, including oil, fuel, and water. Optimize your liquid transportation needs with the Sinotruk 4 Cubic Meter Tanker, a reliable and durable solution for efficient delivery.</p>
      <br />
...
export default OilFuelWaterTanker10Cubic;
