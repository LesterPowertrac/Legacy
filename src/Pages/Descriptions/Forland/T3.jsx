...
const T3 = () => {
  ...
  const Forland = [{ image: images.T3, name: 'T3', link: 'T3' }];
  ...
  return (
    <div id="T3" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland T3 Cargo Truck</h1>
              <br />
              <p className='text-white'>The Forland T3 Cargo Truck is a versatile light-duty vehicle designed for various transportation needs, offering a balance of maneuverability and cargo capacity. Maximize your urban deliveries with the Forland T3 Cargo Truck, the ideal solution for efficient and reliable transportation in tight city spaces.</p>
              <br />
