...
const T54x2 = () => {
  ...
  const Forland = [{ image: images.T54x2, name: 'T54x2', link: 'T54x2' }];
  ...
  return (
    <div id="T54x2" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
          ...
          >
            ...
            >
              <img
                ...
                src={Forland.image}
                alt={Forland.name}
                className="object-contain w-auto text-transparent relative lg:bottom-4 bottom-1"
              />
              {loading && (
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland T5 4x2 Dump Truck </h1>
              <br />
              <p className='text-white'>The Forland T5 4x2 Dump Truck is a versatile medium-duty vehicle designed for efficient material transportation, offering a robust build and reliable performance. Maximize your construction site efficiency with the Forland T5 4x2 Dump Truck, the ideal solution for heavy-duty hauling and material transport.</p>
              <br />
