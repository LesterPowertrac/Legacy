...
const ShacmanWingVan = () => {
  ...
  const Shacman = [{ image: images.ShacmanWingVan, name: 'ShacmanWingVan', link: 'ShacmanWingVan' }];
  ...
  return (
    <div id="ShacmanWingVan" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Wing Van</h1>
      <br />
      <p className='text-white'>The Shacman Wing Van is a heavy-duty vehicle designed for efficient transportation of various goods, offering a spacious cargo area and reliable performance. Optimize your cargo transportation needs with the Shacman Wing Van, the ideal solution for efficient and secure delivery.</p>
      <br />
