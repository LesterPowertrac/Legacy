...
const Giga8x4CargoHead = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga8x4CargoHead, name: 'Giga8x4CargoHead', link: 'Giga8x4CargoHead' }];
  ...
  return (
    <div id="Giga8x4CargoHead" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[340px] h-[260px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-10 -bottom-12"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Giga 8x4 Cargo Head</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu Giga 8x4 Cargo Head is a heavy-duty tractor unit designed for long-haul transportation of extremely heavy loads, offering robust performance and superior load-carrying capacity. Maximize your heavy-haul logistics operations with the Kingling Isuzu Giga 8x4 Cargo Head, the ultimate solution for reliable and efficient transport of the heaviest loads.</p>
      <br />
...
export default Giga8x4CargoHead;
