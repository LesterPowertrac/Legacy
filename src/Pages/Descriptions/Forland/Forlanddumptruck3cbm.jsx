...
const Forlanddumptruck3cbm = () => {
  ...
  const Forland = [{ image: images.Forlanddumptruck3cbm, name: 'Forlanddumptruck3cbm', link: 'Forlanddumptruck3cbm' }];
  ...
  return (
    <div id="Forlanddumptruck3cbm" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[250px] h-[205px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
                alt={Forland.name}
                className="object-contain w-auto text-transparent relative lg:bottom-5 bottom-0"
              />
              {loading && (
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland Dump Truck 3CBM</h1>
              <br />
              <p className='text-white'>The Forland Dump Truck 3CBM is a 3-cubic-meter dump truck, ideal for various construction and material transport tasks. Boost your productivity with the Forland Dump Truck 3CBM, a reliable and powerful tool for your construction projects.</p>
              <br />
...
export default Forlanddumptruck3cbm;
