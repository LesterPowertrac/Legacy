...
const Isuzu700PFFRMediumDutyTruck = () => {
  ...
  const productImages = {
    Isuzu700PFFRMediumDutyTruck: `${apiUrl}/products/700PFFRMediumDutyTruck`,
  };
  ...
  const KinglingIsuzu = [{ image: images.Isuzu700PFFRMediumDutyTruck, name: 'Isuzu700PFFRMediumDutyTruck', link: 'Isuzu700PFFRMediumDutyTruck' }];
  ...
  return (
    <div id="Isuzu700PFFRMediumDutyTruck" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[370px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:bottom-0 -bottom-10"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Kingling Isuzu 700PFFR MediumDuty Truck</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu 700PFFR is a versatile medium-duty truck designed for various transportation needs, offering a balance of power, fuel efficiency, and durability. Optimize your medium-duty operations with the Kingling Isuzu 700PFFR, the ideal solution for reliable and efficient transportation.</p>
      <br />
...
export default Isuzu700PFFRMediumDutyTruck;
