...
const ShacmanFuelTanker = () => {
  ...
  const Shacman = [{ image: images.ShacmanFuelTanker, name: 'ShacmanFuelTanker', link: 'ShacmanFuelTanker' }];
  ...
  return (
    <div id="ShacmanFuelTanker" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Fuel Tanker</h1>
      <br />
      <p className='text-white'>The Shacman Fuel Tanker is a heavy-duty vehicle designed for safe and efficient transportation of various liquids, including fuel and oil.   
      Marketing-Oriented:</p>
      <br />
...
export default ShacmanFuelTanker;
