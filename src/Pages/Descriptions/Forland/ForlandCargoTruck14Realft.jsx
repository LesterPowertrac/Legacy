...
const ForlandCargoTruck14Realft = () => {
  ...
  const productImages = {
    ForlandCargoTruck14Realft: `${apiUrl}/products/ForlandCargoTruck14Realft`,
  };
  ...
  const Forland = [{ image: images.ForlandCargoTruck14Realft, name: 'ForlandCargoTruck14Realft', link: 'ForlandCargoTruck14Realft' }];
  ...
  return (
    <div id="ForlandCargoTruck14Realft" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland Cargo Truck 14 Realft</h1>
              <br />
              <p className='text-white'>The Forland Cargo Truck 14 Realft is a powerful 14-foot cargo truck designed for heavy-duty hauling, featuring a robust build and ample cargo space. Experience unmatched power and versatility with the Forland Cargo Truck 14 Realft, the ultimate solution for your business needs.</p>
              <br />
...
export default ForlandCargoTruck14Realft;
