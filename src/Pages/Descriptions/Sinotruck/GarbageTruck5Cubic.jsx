...
const GarbageTruck5Cubic = () => {
  ...
  const Sinotruck = [{ image: images.GarbageTruck5Cubic, name: 'GarbageTruck5Cubic', link: 'GarbageTruck5Cubic' }];
  ...
  return (
    <div id="GarbageTruck5Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[300px] h-[250px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
        alt={Sinotruck.name}
        className="object-contain w-auto text-transparent relative lg:bottom-10 -bottom-2"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Garbage Truck 5 Cubic</h1>
      <br />
      <p className='text-white'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Consequatur fugit, in possimus cum obcaecati aspernatur quaerat id numquam. Sint quas neque nulla consequuntur molestiae unde numquam aliquid suscipit iste error!</p>
      <br />
...
export default GarbageTruck5Cubic;
