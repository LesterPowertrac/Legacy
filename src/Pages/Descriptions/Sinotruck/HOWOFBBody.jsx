...
const HOWOFBBody = () => {
  ...
  const Sinotruck = [{ image: images.HOWOFBBody, name: 'HOWOFBBody', link: 'HOWOFBBody' }];
  ...
  return (
    <div id="HOWOFBBody" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[390px] h-[280px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
    ...
    >
      <h1 className="text-4xl text-indigo-500">HOWO FB Body</h1>
      <br />
