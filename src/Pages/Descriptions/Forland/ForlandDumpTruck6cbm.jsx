...
const ForlandDumpTruck6cbm = () => {
  ...
  const Forland = [{ image: images.ForlandDumpTruck6cbm, name: 'ForlandDumpTruck6cbm', link: 'ForlandDumpTruck6cbm' }];
  ...
  return (
    <div id="ForlandDumpTruck6cbm" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
        ...
        {Forland.map((Forland) => (
          ...
          >
            {/* Image Container */}
            <div 
              className="flex flex-col items-center box-content lg:h-[300px] h-[220px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
            >
              <img
                loading="lazy"
                src={Forland.image}
                alt={Forland.name}
                className="object-contain w-auto text-transparent relative lg:bottom-3 bottom-0"
              />
              {loading && (
            ...
            >
              <h1 className="text-4xl text-indigo-500">Forland Dump Truck 6CBM</h1>
              <br />
              <p className='text-white'>The Forland Dump Truck 6CBM is a 6-cubic-meter dump truck, designed to handle large-scale material transport with ease. Maximize your hauling efficiency with the Forland Dump Truck 6CBM, the ideal choice for heavy-duty construction projects.</p>
              <br />
...
export default ForlandDumpTruck6cbm;
