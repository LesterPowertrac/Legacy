...
const GigaBoomRed = () => {
  ...
  const KinglingIsuzu = [{ image: images.GigaBoomRed, name: 'GigaBoomRed', link: 'GigaBoomRed' }];
  ...
  return (
    <div id="GigaBoomRed" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Giga Boom Red</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu Giga Boom Red is a heavy-duty truck equipped with a hydraulic boom, designed for various lifting and transportation tasks. Maximize your operational efficiency with the Kingling Isuzu Giga Boom Red, the ideal solution for heavy-duty lifting and transportation needs.</p>
      <br />
