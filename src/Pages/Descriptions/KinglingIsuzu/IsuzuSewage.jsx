...
const IsuzuSewage = () => {
  ...
  const KinglingIsuzu = [{ image: images.IsuzuSewage, name: 'IsuzuSewage', link: 'IsuzuSewage' }];
  ...
  return (
    <div id="IsuzuSewage" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[300px] h-[230px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-8 -bottom-10"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Kingling Isuzu Sewage</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu Sewage Truck is a heavy-duty vehicle designed for efficient sewage collection and transportation, featuring a robust build and advanced suction technology. Optimize your sanitation operations with the Kingling Isuzu Sewage Truck, the ideal solution for efficient and hygienic sewage disposal.</p>
      <br />
