...
const ShacmanDumpTruckX3000 = () => {
  ...
  const Shacman = [{ image: images.ShacmanDumpTruckX3000, name: 'ShacmanDumpTruckX3000', link: 'ShacmanDumpTruckX3000' }];
  ...
  return (
    <div id="ShacmanDumpTruckX3000" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Dump Truck X3000</h1>
      <br />
      <p className='text-white'>The Shacman X3000 Dump Truck is a heavy-duty vehicle designed for efficient material transportation, offering a robust build, advanced technology, and superior performance. Maximize your construction site efficiency with the Shacman X3000 Dump Truck, the ideal solution for heavy-duty hauling and material transport.</p>
      <br />
...
export default ShacmanDumpTruckX3000;
