...
const Giga6x2CargoHead = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga6x2CargoHead, name: 'Giga6x2CargoHead', link: 'Giga6x2CargoHead' }];
  ...
  return (
    <div id="Giga6x2CargoHead" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        className="object-contain w-auto text-transparent relative lg:bottom-2 -bottom-6"
      />
      {loading && (
...
export default Giga6x2CargoHead;
