...
const Giga6x4DumpTruck = () => {
  ...
  const KinglingIsuzu = [{ image: images.Giga6x4DumpTruck, name: 'Giga6x4DumpTruck', link: 'Giga6x4DumpTruck' }];
  ...
  return (
    <div id="Giga6x4DumpTruck" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[390px] h-[250px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-20 -bottom-10"
      />
      {loading && (
...
export default Giga6x4DumpTruck;
