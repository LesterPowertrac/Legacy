...
const TractorheadH3000 = () => {
  ...
  const productImages = {
    TractorheadH3000: `${apiUrl}/products/TractorheadH3000`,
  };
  ...
  const Shacman = [{ image: images.TractorheadH3000, name: 'TractorheadH3000', link: 'TractorheadH3000' }];
  ...
  return (
    <div id="TractorheadH3000" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
          <title>Product Descriptions | The Legacy</title>
          <meta name="description" content="Explore our extensive range of construction equipment, trucks, and machinery from top brands like Shacman, Powerquip, Shacman, Kingling Isuzu, Sinotruck, and Forland." />
        </Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[330px] h-[290px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Shacman.image}
        alt={Shacman.name}
        className="object-contain w-auto text-transparent relative lg:bottom-20 bottom-0"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Shacman Tractor Head H3000</h1>
      <br />
      <p className='text-white'>The Shacman H3000 Tractor Head is a heavy-duty tractor unit designed for long-haul transportation, offering robust performance and fuel efficiency. Maximize your long-haul logistics operations with the Shacman H3000 Tractor Head, the ideal solution for reliable and efficient freight transport.</p>
      <br />
...
export default TractorheadH3000;
