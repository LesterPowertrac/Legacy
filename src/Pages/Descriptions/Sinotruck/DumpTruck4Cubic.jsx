...
const DumpTruck4Cubic = () => {
  ...
  const Sinotruck = [{ image: images.DumpTruck4Cubic, name: 'DumpTruck4Cubic', link: 'DumpTruck4Cubic' }];
  ...
  return (
    <div id="DumpTruck4Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
          <title>Product Descriptions | The Legacy</title>
          <meta name="description" content="Explore our extensive range of construction equipment, trucks, and machinery from top brands like Sinotruck, Powerquip, Sinotruck, Kingling Isuzu, Sinotruck, and Forland." />
        </Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[250px] h-[200px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
        alt={Sinotruck.name}
        className="object-contain w-auto text-transparent relative lg:bottom-10 -bottom-0"
      />
      {loading && (
        <div className="flex flex-col items-center justify-center">
          <Oval color="#F97316" secondaryColor="#FF8C00" height={40} width={40} />
        </div>
      )}
    </div>
    ...
    >
      <h1 className="text-4xl text-indigo-500">Sinotruk 4-Cubic Meter Dump Truck</h1>
      <br />
      <p className='text-white'>The Sinotruk 4-Cubic Meter Dump Truck is a medium-duty vehicle designed for efficient material transportation, offering a robust build and reliable performance. Optimize your construction site efficiency with the Sinotruk 4-Cubic Meter Dump Truck, the ideal solution for heavy-duty hauling and material transport.</p>
      <br />
...
export default DumpTruck4Cubic;
