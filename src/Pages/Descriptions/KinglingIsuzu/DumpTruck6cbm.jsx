...
const DumpTruck6cbm = () => {
  ...
  const KinglingIsuzu = [{ image: images.DumpTruck6cbm, name: 'DumpTruck6cbm', link: 'DumpTruck6cbm' }];
  ...
  return (
    <div id="DumpTruck6cbm" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[350px] h-[280px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={KinglingIsuzu.image}
        alt={KinglingIsuzu.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-5  -bottom-12"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Dump Truck 6cbm</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu 6CBM Dump Truck is a heavy-duty vehicle designed for efficient material transportation, offering a robust build and reliable performance. Maximize your construction site efficiency with the Kingling Isuzu 6CBM Dump Truck, the ideal solution for heavy-duty hauling and material transport.</p>
      <br />
