...
const DumpTruck12Cubic = () => {
  ...
  const Sinotruck = [{ image: images.DumpTruck12Cubic, name: 'DumpTruck12Cubic', link: 'DumpTruck12Cubic' }];
  ...
  return (
    <div id="DumpTruck12Cubic" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[320px] h-[290px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
        src={Sinotruck.image}
        alt={Sinotruck.name}
        className="object-contain w-auto text-transparent relative lg:bottom-10 -bottom-5"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Dump Truck 12 Cubic</h1>
      <br />
      <p className='text-white'>The Sinotruk 12-Cubic Meter Dump Truck is a heavy-duty vehicle designed for efficient material transportation, offering a robust build and reliable performance. Maximize your construction site efficiency with the Sinotruk 12-Cubic Meter Dump Truck, the ideal solution for large-scale hauling and material transport.</p>
      <br />
...
export default DumpTruck12Cubic;
