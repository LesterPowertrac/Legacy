...
const FVR = () => {
  ...
  const KinglingIsuzu = [{ image: images.FVR, name: 'FVR', link: 'FVR' }];
  ...
  return (
    <div id="FVR" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  <div 
    className="flex flex-col items-center mb-8 lg:flex-row lg:items-start lg:justify-between w-9/12 lg:w-[1150px] md:w-auto mt-16" 
    key={KinglingIsuzu.name}
  >
    {/* Image Container */}
    <div 
      className="flex flex-col items-center box-content lg:h-[400px] h-[300px] lg:w-11/12 md:w-[350px] sm:w-[300px]  p-6 lg:p-10 border-4 lg:mx-0"
    >
      <img
        loading="lazy"
    ...
    >
      <h1 className="text-4xl text-indigo-500">FVR 8x4 Trator Head</h1>
      <br />
      <p className='text-white'>The Kingling Isuzu FVR 8x4 Tractor Head is an 8x4 configuration designed for heavy-duty hauling, offering exceptional power and durability for demanding long-haul transportation. Maximize your heavy-haul logistics with the Kingling Isuzu FVR 8x4 Tractor Head, engineered for superior performance and designed to conquer the toughest routes.</p>
      <br />
