...
const EvShacman = () => {
  ...
  const Shacman = [{ image: images.EvShacman, name: 'EvShacman', link: 'EvShacman' }];
  ...
  return (
    <div id="EvShacman" className="flex flex-col items-center justify-between overflow-hidden h-full">
      <HelmetProvider>
        <Helmet>
  ...
  >
    ...
    >
      <img
        ...
        src={Shacman.image}
        alt={Shacman.name}
        className="object-contain w-auto text-transparent relative lg:-bottom-20 -bottom-24"
      />
      {loading && (
    ...
    >
      <h1 className="text-4xl text-indigo-500">Ev Shacman</h1>
      <br />
      <p className='text-white'>The EV Shacman truck is a robust electric-powered commercial vehicle, offering sustainable and efficient transportation solutions with advanced technology for heavy-duty hauling and long-distance operations</p>
      <br />
